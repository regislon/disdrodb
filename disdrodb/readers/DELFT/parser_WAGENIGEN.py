...
# Encodings
from disdrodb.data_encodings import get_WAGENIGEN_dict
from disdrodb.data_encodings import get_WAGENIGEN_dims_dict
...
def reformat_WAGENIGEN_files(file_list, processed_dir, attrs, verbose):
    '''
    ...
    try:
        ...
        ds = xr.open_mfdataset(file_list, combine='nested', concat_dim='times', chunks = {'times':1440})
    ...
    temp_dict_dims = get_WAGENIGEN_dims_dict()
    ...
    data_vars_to_drop = ['Meas_Time_________TO_CHECK_VALUE_INTO_DATA_ENCONDINGS',
                        'Meas_Interval_________TO_CHECK_VALUE_INTO_DATA_ENCONDINGS',
                        ]
...
def main(raw_dir,
    ...
    for station_id in list_stations_id:
        ...
        ds = reformat_WAGENIGEN_files(file_list, processed_dir, attrs, verbose)
...
if __name__ == "__main__":
    # main()
    main(raw_dir = "/SharedVM/Campagne/DELFT/Raw/WAGENIGEN",
        processed_dir = "/SharedVM/Campagne/DELFT/Processed/WAGENIGEN",
        l0_processing=False,
        l1_processing=False,
        write_netcdf=False,
        force=True,
